...
The [MINT](https://github.com/orgMINT/MINT) minimalist interpreter forked for use with the [BeanZee development board](https://github.com/PainfulDiodes/BeanZee) and [z80-breadboard-computer](https://github.com/PainfulDiodes/z80-breadboard-computer)

The repo has also been adapted to be built with [SjASMPlus](https://github.com/z00m128/sjasmplus) Z80 command-line cross-compiler, rather than the web-based [asm80](https://www.asm80.com) used in the original project.
...
- [MINT for BeanZee](#mint-for-beanzee)
- [MINT Language 2.0](#mint-language-20)
  ...
  - [Stack Manipulation in MINT](#stack-manipulation-in-mint)
    - [Duplicate](#duplicate)
    - [Drop](#drop)
    - [Swap](#swap)
    - [Over](#over)
  ...
  - [Appendices](#appendices)
    ...
    - [Byte Mode Operations](#byte-mode-operations)
  ...
  - [Algorithm Examples](#algorithm-examples)
    ...
    - [Example of Calling the Function:](#example-of-calling-the-function)
    - [2. Factorial Function](#2-factorial-function)
    - [3. Sieve of Eratosthenes](#3-sieve-of-eratosthenes)
    - [Explanation:](#explanation)
    - [Example of Calling the Function:](#example-of-calling-the-function-1)
    - [4. Greatest Common Divisor (GCD) using Euclidean Algorithm](#4-greatest-common-divisor-gcd-using-euclidean-algorithm)
    - [Example of Calling the Function:](#example-of-calling-the-function-2)
    - [Example:](#example)
    - [5. Bubble Sort](#5-bubble-sort)
    - [Example of Calling the Function:](#example-of-calling-the-function-3)
    - [Example of Calling the Function:](#example-of-calling-the-function-4)
    - [Example of Calling the Function:](#example-of-calling-the-function-5)
    - [6. Binary Search](#6-binary-search)
    - [Example of Calling the Function:](#example-of-calling-the-function-6)
    - [7. Quick Sort](#7-quick-sort)
    - [Example of Calling the Function:](#example-of-calling-the-function-7)
    - [8. Tower of Hanoi](#8-tower-of-hanoi)
    - [Example of Calling the Function:](#example-of-calling-the-function-8)
    - [9. Insertion Sort](#9-insertion-sort)
    - [Example of Calling the Function:](#example-of-calling-the-function-9)
    - [10. Dijkstra's Algorithm (Shortest Path)](#10-dijkstras-algorithm-shortest-path)
    - [Example of Calling the Function:](#example-of-calling-the-function-10)
